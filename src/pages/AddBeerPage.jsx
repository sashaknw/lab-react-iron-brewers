...
const URLBeer = "https://ih-beers-api2.herokuapp.com/beers/new";
...
function AddBeerPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    axios
      .post(URLBeer, requestBeer)
      .then((response) => navigate("/"))
      .catch((error) => console.log(error));
    if (name && tagline && description && imageUrl && firstBrewed && brewersTips && attenuationLevel && contributedBy) {
